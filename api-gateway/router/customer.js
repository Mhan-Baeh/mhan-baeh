...
router.get("/api/addresses/customers/:custmoerId", auth.protected(auth.admin, auth.customer), auth.authorized([{role: "admin"}, {role: "customer", idParam: "customerId"}]), customerCtrl.get) // customer(self), admin
