...
export const ProductEdit = () => {
  ...
  const [imageShowCols, setImageShowCols] = useState<number>(4);

  const allowedExtension = ["image/jpeg", "image/jpg", "image/png"];

  useEffect(() => {
    if (!watch("image_urls") || watch("image_urls").length === 0) {
      ...
      >
        ...
        <div className="mt-6">
          ...
          <div className="flex flex-col">
            ...
            >
              * For better ai's prediction accuracy, we recommend images with
        ...
        >
          ...
          {Array.isArray(uploadedImages) &&
            uploadedImages.length === 0 &&
            watch("image_urls")?.map((item: string) => (
